...
//x = "<button onclick=\"select_event('" + users[i].username + "')\" class=\"ui-btn ui-icon-bullets ui-btn-notext ui-corner-all\" data-transition=\"pop\" ></button>";
      x = "<button onclick=\"select_event('" + users[i].username + "')\" class=\"ui-btn ui-icon-bullets ui-btn-notext ui-corner-all\" iconpos='notext' icon='bullets' data-transition=\"pop\" ></button>";
